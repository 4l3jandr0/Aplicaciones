...
**ALEX BREVIARIO** R cuenta con documentación para resolver muchas de las dudas que puedas tener sobre el uso de una función o paquete, siendo primer aprendiz o alguien con más tiempo de experiencia. La siguiente tabla resume varias formas en las que puedes pedir ayuda.
...
**ALEX** \# Pruebas estadísticas **ALEX** \# Funciones reciclables
