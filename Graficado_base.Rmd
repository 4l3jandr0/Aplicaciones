...
```
Siguiendo la misma lógica, si solo se usará una de las columnas, entonces el primer espacio debe quedar vacío y colocarse una coma. De tal modo que para extraer la última columna será así:
