...
Para usar GitHub como control de versiones no basta con tener una cuenta, debe crearse un enlace entre la plataforma y el IDE de R, *RStudio*. Para ello, es necesario descargar y ejecutar *__[GIT a través de este enlace](https://git-scm.com/)__*. 
