...
Saber como es que se extraen elementos de un objeto es de suma importancia para el momento de hacer algún operaciones, análisis y construcción de gráficos. A continuación se presenta una tabla con los operadores tradicionales de extracción.
...
```
Se indicaron las posiciones de los objetos dentro del vector, similar a los ejemplos anteriores.
...
Obtener ayuda Extracción de datos tradicional
