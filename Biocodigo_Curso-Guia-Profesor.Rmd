...
* NOTA: en clase se debe destacar que al abrir RStudio por primera vez o un proyecto nuevo, solo aparecerán **3** ventanas, la **4** se genera al abrir un documento (sript, RMarkdown, etc.)
